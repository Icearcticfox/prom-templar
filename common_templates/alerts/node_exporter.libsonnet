        ...
        rules: [
          {
            ...
            expr: |||
              node_filesystem_avail_bytes{%(nodeExporterSelector)s,%(fsSelector)s} / node_filesystem_size_bytes{%(nodeExporterSelector)s,%(fsSelector)s} * 100 < %(nodeWarningDiskSpaceUsage)s
            ||| % $._config,
            'for': '1h',
            labels: {
              ...
              input_series: [
                {
                  series: 'node_filesystem_size_bytes{'
                          + $._config.unit_tests.node_exporter.metric_lablels
                          + '}',
          ...
          },
          {
            ...
            expr: |||
              node_filesystem_avail_bytes{%(nodeExporterSelector)s,%(fsSelector)s} / node_filesystem_size_bytes{%(nodeExporterSelector)s,%(fsSelector)s} * 100 < %(nodeCriticalDiskSpaceUsage)s
            ||| % $._config,
            'for': '1h',
            labels: {
            ...
            alert_rule_test: {
              exp_labels: $._config.unit_tests.node_exporter.exp_labels_critical,
              exp_annotations:
                {
                  summary: 'Filesystem is predicted to run out of space within the next 4 hours.',
                  description: 'Filesystem on '
                               ...
                               + ', at '
                               + $._config.unit_tests.node_exporter.exp_labels.instance
                               + ' has only 9.65% available space left and is filling up fast.',
                },
              input_series: [
                {
                  series: 'node_filesystem_size_bytes{'
                          + $._config.unit_tests.node_exporter.metric_lablels
                          + '}',
                  values: '1055882158018x60',
                },
                {
                  series: 'node_filesystem_avail_bytes{'
                          + $._config.unit_tests.node_exporter.metric_lablels
                          + '}',
                  values: '101882158098x60',
                },
              ],
            },
          },
          {
            alert: 'NodeFilesystemAlmostOutOfSpaceWarn',
            expr: |||
              (
              ...
              exp_annotations:
                {
                  ...
                  description: 'Filesystem on '
                               ...
                               + ', at '
                               + $._config.unit_tests.node_exporter.exp_labels.instance
                               + ' has only 3.98% available space left.',
                },
              input_series: [
                {
                  series: 'node_filesystem_avail_bytes{'
                          + $._config.unit_tests.node_exporter.metric_lablels
                          + '}',
                  values: '1018821580x60',
                },
                {
                  series: 'node_filesystem_size_bytes{'
                          + $._config.unit_tests.node_exporter.metric_lablels
                          + '}',
                  values: '25588215818x60',
                },
                {
                  series: 'node_filesystem_readonly{'
                          + $._config.unit_tests.node_exporter.metric_lablels
                          + '}',
                  values: '0x60',
                },
          ...
          {
            alert: 'NodeFilesystemAlmostOutOfSpaceCrit',
            expr: |||
              (
          ...
          {
            alert: 'NodeFilesystemFilesFillingUpWarn',
            expr: |||
              (
          ...
          {
            alert: 'NodeFilesystemFilesFillingUpCrit',
            expr: |||
              (
          ...
          {
            alert: 'NodeFilesystemAlmostOutOfFilesWarn',
            expr: |||
              (
          ...
          {
            alert: 'NodeFilesystemAlmostOutOfFilesCrit',
            expr: |||
              (
          ...
          {
            alert: 'NodeFileDescriptorLimitWarn',
            expr: |||
              (
          ...
          {
            alert: 'NodeFileDescriptorLimitCrit',
            expr: |||
              (
          ...
          },
          {
            ...
            'for': '15m',
            labels: {
              severity: '%(InfoSeverity)s' % $._config,
            },
            annotations: {
          ...
          },
          {
            ...
            expr: |||
              node_systemd_unit_state{%(nodeExporterSelector)s, state="failed", %(SystemdServiceFailedInstanceName)s} == 1
            ||| % $._config,
            'for': '5m',
            labels: {
              severity: '%(WarningSeverity)s' % $._config,
